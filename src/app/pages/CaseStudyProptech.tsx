...
.segment-count { font-family: var(--display); font-size: 11px; color: var(--white) !important; margin-top: 2px; }
...
.pmf-label { font-family: var(--display); font-size: 11px; color: var(--light-gray) !important; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 7px; }
.pmf-text { font-family: var(--body); font-size: 16px; line-height: 1.75; color: var(--cream) !important; }

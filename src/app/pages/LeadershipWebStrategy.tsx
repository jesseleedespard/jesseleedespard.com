...
.hero h1 { font-family: var(--display); font-size: clamp(var(--font-size-2xl), 4.5vw, var(--font-size-3xl)); font-weight: 700; color: var(--white); line-height: 1.15; letter-spacing: -0.5px; margin-bottom: 8px; }
...
@media (max-width: 768px) {
  ...
  .leadership-web-strategy-page .hero { padding: var(--space-hero-mobile) var(--space-page-side-mobile) 40px !important; }
  ...
  .leadership-web-strategy-page .hero h1 { font-size: clamp(var(--font-size-xl), 6vw, var(--font-size-2xl)) !important; line-height: 1.2 !important; }
  .leadership-web-strategy-page .hero-sub { font-size: var(--font-size-base) !important; max-width: 100% !important; }
...
@media (max-width: 480px) {
  ...
  .leadership-web-strategy-page .hero h1 { font-size: clamp(var(--font-size-xl), 7vw, var(--font-size-2xl)) !important; }
